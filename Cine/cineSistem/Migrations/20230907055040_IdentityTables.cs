...
namespace cineSistem.Migrations
{
    /// <inheritdoc />
    public partial class IdentityTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    idPel = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__pelicula__3D78D11A11A30BBD", x => x.idPel);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__usuario__3717C982048E11CA", x => x.idUser);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__rankingP__3214EC071A9437B9", x => x.Id);
                    table.ForeignKey(
                        name: "FK_peliculaRank",
                        column: x => x.idPel,
                        principalTable: "pelicula",
                        principalColumn: "idPel");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_rankingPelicula_idPel",
                table: "rankingPelicula",
                column: "idPel");
        }
